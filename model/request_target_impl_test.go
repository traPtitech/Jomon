...
func TestEntRepository_GetRequestTargets(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		request, err := repo.CreateRequest(ctx, random.Numeric(t, 1000000), random.AlphaNumeric(t, 40), random.AlphaNumeric(t, 40), nil, []*RequestTarget{target1, target2}, nil, user1.ID)
		require.NoError(t, err)
...
func TestEntRepository_createRequestTargets(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		got, err := repo.CreateRequest(ctx, random.Numeric(t, 1000000), random.AlphaNumeric(t, 40), random.AlphaNumeric(t, 40), nil, []*RequestTarget{target1, target2}, nil, user1.ID)
		assert.NoError(t, err)
...
func TestEntRepository_deleteRequestTargets(t *testing.T) {
	...
	t.Run("Success2", func(t *testing.T) {
		...
		request, err := repo.CreateRequest(ctx, random.Numeric(t, 1000000), random.AlphaNumeric(t, 40), random.AlphaNumeric(t, 40), nil, nil, nil, user1.ID)
		require.NoError(t, err)
