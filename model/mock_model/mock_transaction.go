...
func (mr *MockTransactionRepositoryMockRecorder) CreateTransaction(ctx, Amount, Target, tags, group, requestID any) *gomock.Call {
...
func (mr *MockTransactionRepositoryMockRecorder) UpdateTransaction(ctx, transactionID, Amount, Target, tags, group, requestID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
