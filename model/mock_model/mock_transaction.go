...
func (mr *MockTransactionRepositoryMockRecorder) CreateTransaction(ctx, title, Amount, Target, tags, group, requestID interface{}) *gomock.Call {
...
func (mr *MockTransactionRepositoryMockRecorder) UpdateTransaction(ctx, transactionID, title, Amount, Target, tags, group, requestID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
