...
//
//	mockgen -source=group.go -destination=mock_model/mock_group.go -package=mock_model
//
...
func (mr *MockGroupRepositoryMockRecorder) AddMembers(ctx, groupID, userIDs any) *gomock.Call {
...
func (mr *MockGroupRepositoryMockRecorder) AddOwners(ctx, groupID, ownerIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) CreateGroup(ctx, name, description, budget any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) DeleteGroup(ctx, groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) DeleteMembers(ctx, groupID, userIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) DeleteOwners(ctx, groupID, ownerIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) GetGroup(ctx, groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) GetGroups(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) GetOwners(ctx, groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGroupRepositoryMockRecorder) UpdateGroup(ctx, groupID, name, description, budget any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
