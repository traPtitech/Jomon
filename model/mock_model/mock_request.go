...
func (m *MockRequestRepository) CreateRequest(ctx context.Context, amount int, title, content string, tags []*model.Tag, group *model.Group, userID uuid.UUID) (*model.RequestDetail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRequest", ctx, amount, title, content, tags, group, userID)
...
func (mr *MockRequestRepositoryMockRecorder) CreateRequest(ctx, amount, title, content, tags, group, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRequest", reflect.TypeOf((*MockRequestRepository)(nil).CreateRequest), ctx, amount, title, content, tags, group, userID)
}
...
func (m *MockRequestRepository) UpdateRequest(ctx context.Context, requestID uuid.UUID, amount int, title, content string, tags []*model.Tag, group *model.Group) (*model.RequestDetail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateRequest", ctx, requestID, amount, title, content, tags, group)
	ret0, _ := ret[0].(*model.RequestDetail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRequestRepositoryMockRecorder) UpdateRequest(ctx, requestID, amount, title, content, tags, group interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRequest", reflect.TypeOf((*MockRequestRepository)(nil).UpdateRequest), ctx, requestID, amount, title, content, tags, group)
}
