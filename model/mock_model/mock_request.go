...
func (mr *MockRequestRepositoryMockRecorder) CreateRequest(ctx, title, content, tags, targets, group, userID interface{}) *gomock.Call {
...
func (mr *MockRequestRepositoryMockRecorder) UpdateRequest(ctx, requestID, title, content, tags, targets, group interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
