...
var (
	...
	CommentsColumns = []*schema.Column{
		...
		{Name: "request_comment", Type: field.TypeInt, Nullable: true},
	}
	...
	GroupBudgetsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "group_group_budget", Type: field.TypeInt, Nullable: true},
	}
	...
	GroupUsersTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "group_users_groups_user",
	...
	RequestFilesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "request_file", Type: field.TypeInt, Nullable: true},
	}
	...
	RequestFilesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "request_files_requests_file",
	...
	RequestStatusColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "request_status", Type: field.TypeInt, Nullable: true},
	}
	...
	RequestTagsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "request_tag", Type: field.TypeInt, Nullable: true},
		{Name: "tag_request_tag", Type: field.TypeInt, Nullable: true},
	}
	...
	RequestTagsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "request_tags_requests_tag",
				Columns:    []*schema.Column{RequestTagsColumns[2]},
				RefColumns: []*schema.Column{RequestsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "request_tags_tags_request_tag",
				Columns:    []*schema.Column{RequestTagsColumns[3]},
	...
	RequestTargetsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "request_target", Type: field.TypeInt, Nullable: true},
	}
	...
	TransactionDetailsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime},
		{Name: "request_transaction_detail", Type: field.TypeInt, Nullable: true},
		{Name: "transaction_detail", Type: field.TypeInt, Unique: true, Nullable: true},
	}
	...
	TransactionTagsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "tag_transaction_tag", Type: field.TypeInt, Nullable: true},
		{Name: "transaction_tag", Type: field.TypeInt, Nullable: true},
	}
	...
	TransactionTagsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "transaction_tags_tags_transaction_tag",
				Columns:    []*schema.Column{TransactionTagsColumns[1]},
				RefColumns: []*schema.Column{TagsColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "transaction_tags_transactions_tag",
...
func init() {
	...
	RequestTagsTable.ForeignKeys[1].RefTable = TagsTable
	RequestTargetsTable.ForeignKeys[0].RefTable = RequestsTable
	TransactionDetailsTable.ForeignKeys[0].RefTable = RequestsTable
	TransactionDetailsTable.ForeignKeys[1].RefTable = TransactionsTable
	TransactionTagsTable.ForeignKeys[0].RefTable = TagsTable
	TransactionTagsTable.ForeignKeys[1].RefTable = TransactionsTable
}
