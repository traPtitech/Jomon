...
func (rtq *RequestTargetQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (rtq *RequestTargetQuery) FirstIDX(ctx context.Context) int {
...
func (rtq *RequestTargetQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (rtq *RequestTargetQuery) OnlyIDX(ctx context.Context) int {
...
func (rtq *RequestTargetQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (rtq *RequestTargetQuery) IDsX(ctx context.Context) []int {
	ids, err := rtq.IDs(ctx)
	if err != nil {
		panic(err)
	}
