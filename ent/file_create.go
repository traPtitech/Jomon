...
func (_c *FileCreate) SetRequestID(id uuid.UUID) *FileCreate {
...
func (_c *FileCreate) SetNillableRequestID(id *uuid.UUID) *FileCreate {
	if id != nil {
...
func (_c *FileCreate) SetRequest(v *Request) *FileCreate {
