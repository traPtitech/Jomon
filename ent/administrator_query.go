...
// Returns a *NotSingularError when exactly one Administrator entity is not found.
...
// Returns a *NotSingularError when exactly one Administrator ID is not found.
...
func (aq *AdministratorQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	if err := aq.Select(administrator.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (aq *AdministratorQuery) Clone() *AdministratorQuery {
	...
	return &AdministratorQuery{
		...
		predicates: append([]predicate.Administrator{}, aq.predicates...),
...
//
//	client.Administrator.Query().
//		Select(administrator.FieldTrapID).
//		Scan(ctx, &v)
//
func (aq *AdministratorQuery) Select(field string, fields ...string) *AdministratorSelect {
	aq.fields = append([]string{field}, fields...)
	return &AdministratorSelect{AdministratorQuery: aq}
}

func (aq *AdministratorQuery) prepareQuery(ctx context.Context) error {
...
func (aq *AdministratorQuery) sqlAll(ctx context.Context) ([]*Administrator, error) {
	var (
		nodes = []*Administrator{}
		_spec = aq.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		node := &Administrator{config: aq.config}
...
func (aq *AdministratorQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := aq.querySpec()
	return sqlgraph.CountNodes(ctx, aq.driver, _spec)
}

func (aq *AdministratorQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (aq *AdministratorQuery) querySpec() *sqlgraph.QuerySpec {
...
func (aq *AdministratorQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(aq.driver.Dialect())
	t1 := builder.Table(administrator.Table)
	selector := builder.Select(t1.Columns(administrator.Columns...)...).From(t1)
	if aq.sql != nil {
		selector = aq.sql
		selector.Select(selector.Columns(administrator.Columns...)...)
	}
...
func (agb *AdministratorGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("ent: AdministratorGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdministratorGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdministratorGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("ent: AdministratorGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdministratorGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdministratorGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("ent: AdministratorGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdministratorGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdministratorGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("ent: AdministratorGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AdministratorGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AdministratorGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (agb *AdministratorGroupBy) sqlQuery() *sql.Selector {
	selector := agb.sql
...
func (as *AdministratorSelect) Scan(ctx context.Context, v interface{}) error {
	...
	as.sql = as.AdministratorQuery.sqlQuery(ctx)
...
func (as *AdministratorSelect) Strings(ctx context.Context) ([]string, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("ent: AdministratorSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdministratorSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdministratorSelect) Ints(ctx context.Context) ([]int, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("ent: AdministratorSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdministratorSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdministratorSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("ent: AdministratorSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdministratorSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdministratorSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("ent: AdministratorSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AdministratorSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{administrator.Label}
	default:
		err = fmt.Errorf("ent: AdministratorSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AdministratorSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
...
func (as *AdministratorSelect) sqlQuery() sql.Querier {
	selector := as.sql
