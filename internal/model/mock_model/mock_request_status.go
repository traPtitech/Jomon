...
//
//	mockgen -source=request_status.go -destination=mock_model/mock_request_status.go -package=mock_model
//
...
func (mr *MockRequestStatusRepositoryMockRecorder) CreateStatus(ctx, requestID, userID, status any) *gomock.Call {
