...
//
//	mockgen -source=request_target.go -destination=mock_model/mock_request_target.go -package=mock_model
//
...
func (mr *MockRequestTargetRepositoryMockRecorder) GetRequestTargets(ctx, requestID any) *gomock.Call {
