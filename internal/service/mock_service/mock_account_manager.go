...
//
//	mockgen -source=account_manager.go -destination=mock_service/mock_account_manager.go -package=mock_service
//
...
func (m *MockAccountManagerRepository) GetAccountManagers(ctx context.Context) ([]*service.AccountManager, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountManagers", ctx)
	ret0, _ := ret[0].([]*service.AccountManager)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
