...
//
//	mockgen -source=tag.go -destination=mock_service/mock_tag.go -package=mock_service
//
...
func (m *MockTagRepository) CreateTag(ctx context.Context, name string) (*service.Tag, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTag", ctx, name)
	ret0, _ := ret[0].(*service.Tag)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTagRepository) GetTag(ctx context.Context, tagID uuid.UUID) (*service.Tag, error) {
	m.ctrl.T.Helper()
...
func (m *MockTagRepository) GetTags(ctx context.Context) ([]*service.Tag, error) {
	m.ctrl.T.Helper()
...
func (m *MockTagRepository) UpdateTag(ctx context.Context, tagID uuid.UUID, name string) (*service.Tag, error) {
	m.ctrl.T.Helper()
