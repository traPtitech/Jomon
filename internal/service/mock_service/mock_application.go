...
//
//	mockgen -source=application.go -destination=mock_service/mock_application.go -package=mock_service
//
...
func (m *MockApplicationRepository) CreateApplication(ctx context.Context, title, content string, tags []*service.Tag, targets []*service.ApplicationTarget, userID uuid.UUID) (*service.ApplicationDetail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateApplication", ctx, title, content, tags, targets, userID)
	ret0, _ := ret[0].(*service.ApplicationDetail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplicationRepository) GetApplication(ctx context.Context, applicationID uuid.UUID) (*service.ApplicationDetail, error) {
	m.ctrl.T.Helper()
...
func (m *MockApplicationRepository) GetApplications(ctx context.Context, query service.ApplicationQuery) ([]*service.ApplicationResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApplications", ctx, query)
	ret0, _ := ret[0].([]*service.ApplicationResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplicationRepository) UpdateApplication(ctx context.Context, applicationID uuid.UUID, title, content string, tags []*service.Tag, targets []*service.ApplicationTarget) (*service.ApplicationDetail, error) {
	m.ctrl.T.Helper()
